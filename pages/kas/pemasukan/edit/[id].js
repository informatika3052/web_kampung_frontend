...
function EditPemasukan() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess("Data pemasukan berhasil diupdate!");
      setTimeout(() => {
        router.push("/kas/pemasukan");
      }, 1500);
    } catch (err) {
        ...
        <Container fluid>
          ...
          <div className="d-flex align-items-center mb-4">
            ...
            <div>
              ...
              <p className="text-muted">Ubah data pemasukan kas kampung</p>
            </div>
          </div>
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-end gap-2">
                      ...
                      <Button variant="success" type="submit" disabled={saving}>
                        {saving ? "Menyimpan..." : "Update Pemasukan"}
                      </Button>
                    </div>
                  </Form>
                </Card.Body>
...
export default function EditPemasukanPage() {
  return (
